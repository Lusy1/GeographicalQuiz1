...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn = (Button) findViewById(R.id.result_button);
    }
    ...
    private void display(int score) {
        ...
        if (score >= 4) {
            Toast toast = Toast.makeText(getApplicationContext(), "Congratulations! " + name + "! " + "Your Geography knowledge is very good! " + "Score: " + score + "/7", Toast.LENGTH_LONG);
            toast.show();
        }
        if (score <= 3) {
            Toast toast = Toast.makeText(getApplicationContext(), "You can de better, " + name + ". " + "Try again. " + "Score: " + score + "/7", Toast.LENGTH_LONG);
            toast.show();
        }
    }
